...
var writePath = path.join(envPath, './offline_docs/moy/kero-begin.md');
var writePath0 = path.join(envPath, './offline_docs/moy/kero-data.md');
var writePath1 = path.join(envPath, './offline_docs/moy/kero-api.md');
var headData = '',
    beginData = "";
var head_datamodel = '',
    datamodel = "";
