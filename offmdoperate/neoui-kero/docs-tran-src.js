...
var writePath = path.join(envPath, './offline_docs/moy/kero/');
var writePath0 = path.join(envPath, './offline_docs/moy/kero-model.md');
var writePath1 = path.join(envPath, './offline_docs/moy/kero-basic.md');
var componentdata = '';
var basicdata = '';
