...
var ut = require(envPath+'/mdoperate/utool.js')
var ymlPath = path.join(envPath+'/mdoperate', '_config.yml');
...
var snipPath = path.join(envPath, snipConfig+'/neoui-kero');
